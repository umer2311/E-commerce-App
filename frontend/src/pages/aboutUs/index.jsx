...
import Story from "../../assets/images/story3.png";


import CarouselPage from "./carosoul/carosoul";
...
function AboutUs() {
  return (
    ...
    <div className="bg-white min-h-screen">
      ...
      <div className="banner w-full h-80 bg-gray-500 justify-center text-center text-lg flex items-center ">
