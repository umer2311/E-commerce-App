...
import { fetchProductId } from '../../redux/productSlice'
...
<div className="flex flex-row">
                     ...
                     <div><button className="bg-[#292a42] hover:bg-blue-700  text-white font-bold py-4 px-16 rounded-full "><a href="www.youtube.com">Add to Cart</a></button></div>
